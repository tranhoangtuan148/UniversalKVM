...
| Platform | File |
| --- | --- |
| macOS, Apple silicon (M1 and later) | `UniversalKVM-1.0.5-macOS-AppleSilicon.dmg` |
| macOS, Intel | `UniversalKVM-1.0.5-macOS-Intel.dmg` |
| Debian, Ubuntu, Mint | `UniversalKVM-1.0.5-Linux-x86_64.deb` |
| Fedora, RHEL | `UniversalKVM-1.0.5-Linux-x86_64.rpm` |
| Any Linux, portable | `UniversalKVM-1.0.5-Linux-x86_64.AppImage` |
| Windows | `UniversalKVM-1.0.5-Windows-x64.msi` |
...
* Debian, Ubuntu, Mint: download `UniversalKVM-1.0.5-Linux-x86_64.deb` and install it.
* Fedora and other Red Hat based distributions: download
  `UniversalKVM-1.0.5-Linux-x86_64.rpm` and install it.
* Any distribution: download `UniversalKVM-1.0.5-Linux-x86_64.AppImage`, make it
...
1. Download `UniversalKVM-1.0.5-Windows-x64.msi` and install it.
